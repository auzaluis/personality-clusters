        ...
        dashboardSidebar(
            ...
            sidebarMenu(
                ...
                menuItem(text = "Main dashboard",
                         ...
                         menuSubItem(text = "Definición",
                                     tabName = "Definición",
                                     icon = icon(name = "fas fa-angle-double-right")),
                         
                         menuSubItem(text = "Frases",
                                     tabName = "Frases",
                                     icon = icon(name = "fas fa-angle-double-right"))),
                
                menuItem(text = "Agrupación",
        ...
        dashboardBody(
            ...
            fluidRow(
              ...
              tabItems(
                ...
                tabItem(tabName = "Definición",
                        h2("Clustering"),
                        
                        column(width = 5,
                               
                               tabPanel(title = "Definición",
                        ...
                        column(width = 7,
                               ...
                               tabBox(width = 12,
                                      ...
                                      tabPanel(title = "Siluetas",
                                               plotlyOutput(outputId = "SILHOUETTE")),
                                      
                                      tabPanel(title = "Tamaño",
